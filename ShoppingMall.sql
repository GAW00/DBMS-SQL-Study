...
--	STATUS	   NUMBER(10) DEFAULT 1,	-- 1:주문, 2:교환, 3:환불, 4:주소
...
--	PROCODE	  NUMBER(20) NOT NULL,
--	AMOUNT	  NUMBER(20),
--	STATUS	  NUMBER(10) DEFAULT 1,	-- 1: 결제대기, 2: 출고대기, 3: 출고, 4: 취소,
--	OUTDATE	  DATE
--);
--
--CREATE TABLE PRODUCT (
...
--	ORDERCODE NUMBER(20) NOT NULL,
--	PAYPRICE  NUMBER(50),
--	PAYMENT	  NUMBER(10),-- 1: 무통장입금, 2: 신용카드, 3: 카카오페이,
--	ISPAID	  NUMBER(10),
--	ISREFUND  NUMBER(10) DEFAULT 0
--);
--
--CREATE TABLE MEMBER (
--	ID	      VARCHAR2(30) NOT NULL,
...
--	NAME	  VARCHAR2(30),
--	PCODE	  VARCHAR2(30),
--	LOADADDR  VARCHAR2(100),
--	LOTADDR	  VARCHAR2(100),
--	EXTRAADDR VARCHAR2(100),
--	ETCADDR	  VARCHAR2(100),
--	ADMIN	  VARCHAR2(10) DEFAULT 'N'
--);
--
--CREATE TABLE CATEGORY (
--	CATECODE	NUMBER(20) NOT NULL,
...
--	PROCODE	  NUMBER(20) NOT NULL,
--	AMOUNT	  NUMBER(30),
--	ISCHECKED NUMBER(10) DEFAULT 1,
--	ISPAID	  NUMBER(10) DEFAULT 0
--);
--
--CREATE TABLE PRODUCT_REV (
--	REVCODE	NUMBER(20) NOT NULL,
--	PROCODE	NUMBER(20) NOT NULL,
--	REVCONT	VARCHAR2(500),
--	REVAUTH	VARCHAR2(30),
--	REVDATE	DATE
--);
--
...
--);
--
--ALTER TABLE PRODUCT_OUT ADD CONSTRAINT FK_PRODUCT_ORD_TO_PRODUCT_OUT_1 FOREIGN KEY (
--	ORDERCODE
--)
--REFERENCES PRODUCT_ORD (
--	ORDERCODE
--);
--
--ALTER TABLE PAY ADD CONSTRAINT FK_PRODUCT_ORD_TO_PAY_1 FOREIGN KEY (
--	ORDERCODE
--)
--REFERENCES PRODUCT_ORD (
--	ORDERCODE
