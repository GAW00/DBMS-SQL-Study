...
SELECT COUNT(B_ID) FROM BOARDT WHERE B_TITLE = 'd';



SELECT B_ID, B_NAME, B_EMAIL, B_TITLE, B_CONTENT, TO_CHAR(B_DATE,'YYYY-MM-DD HH24:MM') B_DATE, B_HIT, B_PWD, B_IP , B_REF, B_STEP, B_LEVEL, B_FNAME, B_FSIZE FROM BOARDT ORDER BY B_REF DESC, B_STEP WHERE B_TITLE = 'a';
